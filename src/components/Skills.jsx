...
const Skills = () => {
    return (
        <div className="floats" data-aos='zoom-in' data-aos-once='true'>  
			...
			<div className="skill11 float">MySQL</div>  
			<div className="skill11_1 float float2">MongoDB</div> 
			<div className="skill11_2 float float3">Firebase</div> 
			<div className="skill12 float float1">GIT</div>
            ...
            <div className="skill18 float float2">
